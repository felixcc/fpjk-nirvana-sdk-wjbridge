...
public final class Logger {
     ...
     *
     * @param tag is the given string which will be used in LoggerInterceptor
     */
    ...
    public static void e(String tag, String message, Throwable e, int methodCount) {
        validateMethodCount(methodCount);
        ...
        if (message == null) {
            message = "No message/Throwable is set";
        }
